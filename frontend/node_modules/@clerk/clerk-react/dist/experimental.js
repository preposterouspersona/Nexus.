...
var useCustomElementPortal = (elements) => {
  ...
  const [nodes, setNodes] = (0, import_react11.useState)(initialState);
  return elements.map((el, index) => ({
    ...
    portal: () => /* @__PURE__ */ import_react11.default.createElement(import_react11.default.Fragment, null, nodes[index] ? (0, import_react_dom.createPortal)(el.component, nodes[index]) : null)
  }));
};
