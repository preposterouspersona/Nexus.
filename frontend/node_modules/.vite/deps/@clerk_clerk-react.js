...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/chunk-U7L7TR5J.mjs
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/chunk-Y2PJFKKW.mjs
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/chunk-SNP6N6BO.mjs
...
var useCustomElementPortal = (elements) => {
	const [nodes, setNodes] = (0, import_react.useState)(Array(elements.length).fill(null));
	return elements.map((el, index) => ({
		...
		portal: () => /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, nodes[index] ? (0, import_react_dom.createPortal)(el.component, nodes[index]) : null)
	}));
};
...
var useCustomMenuItems = ({ children, MenuItemsComponent, MenuActionComponent, MenuLinkComponent, UserProfileLinkComponent, UserProfilePageComponent, reorderItemsLabels }) => {
	...
	import_react.Children.forEach(children, (child) => {
		if (!isThatComponent(child, MenuItemsComponent) && !isThatComponent(child, UserProfileLinkComponent) && !isThatComponent(child, UserProfilePageComponent)) {
			if (child) logErrorInDevMode(userButtonIgnoredComponent);
			return;
		}
...
function waitForElementChildren(options) {
	...
	return new Promise((resolve, reject) => {
		...
		if (timeout > 0) setTimeout(() => {
			observer.disconnect();
			reject(/* @__PURE__ */ new Error(`Timeout waiting for element children`));
		}, timeout);
	});
}
function useWaitForComponentMount(component) {
	...
	(0, import_react.useEffect)(() => {
		...
		if (typeof window !== "undefined" && !watcherRef.current) watcherRef.current = waitForElementChildren({ selector: `[data-clerk-component="${component}"]` }).then(() => {
			setStatus("rendered");
		}).catch(() => {
			setStatus("error");
		});
...
var TaskSelectOrganization = withClerk(({ clerk, component, fallback, ...props }) => {
	const shouldShowFallback = useWaitForComponentMount(component) === "rendering" || !clerk.loaded;
	const rendererRootProps = { ...shouldShowFallback && fallback && { style: { display: "none" } } };
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, shouldShowFallback && fallback, clerk.loaded && /* @__PURE__ */ import_react.createElement(ClerkHostRenderer, {
		component,
...
var _IsomorphicClerk = class _IsomorphicClerk {
	constructor(options) {
		...
		this.premountTaskSelectOrganizationNodes = /* @__PURE__ */ new Map();
		...
		*/
		...
		this.__internal_navigateToTaskIfAvailable = async (params) => {
			if (this.clerkjs) return this.clerkjs.__internal_navigateToTaskIfAvailable(params);
		...
		*/
		...
		this.mountTaskSelectOrganization = (node, props) => {
			if (this.clerkjs && this.loaded) this.clerkjs.mountTaskSelectOrganization(node, props);
			else this.premountTaskSelectOrganizationNodes.set(node, props);
		};
		this.unmountTaskSelectOrganization = (node) => {
			if (this.clerkjs && this.loaded) this.clerkjs.unmountTaskSelectOrganization(node);
			else this.premountTaskSelectOrganizationNodes.delete(node);
		};
...
setClerkJsLoadingErrorPackageName("@clerk/clerk-react");
//#endregion
export { APIKeys, AuthenticateWithRedirectCallback, ClerkDegraded, ClerkFailed, ClerkLoaded, ClerkLoading, ClerkProvider, CreateOrganization, GoogleOneTap, OrganizationList, OrganizationProfile, OrganizationSwitcher, PricingTable, Protect, RedirectToCreateOrganization, RedirectToOrganizationProfile, RedirectToSignIn, RedirectToSignUp, RedirectToUserProfile, SignIn, SignInButton, SignInWithMetamaskButton, SignOutButton, SignUp, SignUpButton, SignedIn, SignedOut, TaskSelectOrganization, UserButton, UserProfile, Waitlist, __experimental_CheckoutProvider, PaymentElement as __experimental_PaymentElement, PaymentElementProvider as __experimental_PaymentElementProvider, useCheckout as __experimental_useCheckout, usePaymentElement as __experimental_usePaymentElement, useAuth, useClerk, useEmailLink, useOrganization, useOrganizationList, useReverification, useSession, useSessionList, useSignIn, useSignUp, useUser };
